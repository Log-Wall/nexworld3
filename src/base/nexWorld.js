...
const drawMap = ({ context, path, transform }) => {
    ...
    drawFeatures({ context: context, path: path, type: "reefs", rgba: "rgba( 100, 130, 180, 0.55)" });
    drawFeatures({ context: context, path: path, type: "marsh", rgba: "rgba(  55, 140, 135, 0.88)" });
    drawFeatures({ context: context, path: path, type: "grass", rgba: "rgba(  65, 150,  65, 0.25)" });
};
